...
//#import "VTVideoCropController.h"
...
//        _imagePickerVc.navigationBar.barTintColor = kbackgroundColor;
...
//    [self.navigationController.navigationBar setBackgroundImage:[UIImage imageWithColor:kcolor(@"181820")] forBarMetrics:UIBarMetricsDefault];
    UIButton *leftButton = [UIButton buttonWithType:UIButtonTypeCustom];
    leftButton.frame = CGRectMake(-10, 0, 44, 44);
    leftButton.contentHorizontalAlignment = UIControlContentHorizontalAlignmentLeft;
    //leftButton.imageEdgeInsets = UIEdgeInsetsMake(0, -30, 0, 0);
    [leftButton setImage:[UIImage imageNamed:@"recordClose"] forState:UIControlStateNormal];
    ...
    // [self resetCachedAuiis];
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(didChangeStatusBarOrientationNotification:) name:UIApplicationDidChangeStatusBarOrientationNotification object:nil];
//    self.view.backgroundColor = [UIColor colorFromName:@"181820"];
...
//    _collectionView.backgroundColor =  [UIColor colorFromName:@"181820"];
...
- (void)viewDidLayoutSubviews {
    ...
    if (self.navigationController.navigationBar.isTranslucent) {
        ...
        collectionViewHeight = tzImagePickerVc.showSelectBtn ? self.view.tz_height - 0 - top : self.view.tz_height - top;;
    } else {
        collectionViewHeight = tzImagePickerVc.showSelectBtn ? self.view.tz_height - 0 : self.view.tz_height;
    }
    ...
    if (!self.navigationController.navigationBar.isHidden) {
        yOffset = self.view.tz_height - 0;
    } else {
        CGFloat navigationHeight = naviBarHeight;
        if (iOS7Later) navigationHeight += 20;
        yOffset = self.view.tz_height - 0 - navigationHeight;
    }
...
//    if (asset.duration < 3 ) {
//        [ToastManager showAutoDismissedHUDMessage:@"选择片段必须大于3s"];
//        return;
//    } else if(asset.duration > 600) {
//        [ToastManager showAutoDismissedHUDMessage:@"选择片段必须小于10m"];
//        return;
//    } else if(MAX(assetWidth, assetHeight) > 2560 || MIN(assetWidth, assetHeight) > 1440){
//        [ToastManager showAutoDismissedHUDMessage:@"选择片段分辨率不能大于2K"];
//        return;
//    }
...
//        } else {
//            VTVideoCropController *videoPlayerVc = [[VTVideoCropController alloc] init];
//            videoPlayerVc.enableOriginSize = self.enabledOriginSize;
//            videoPlayerVc.longVideo = self.longVideo;
