...
- (void)viewDidLoad {
    ...
    self.preferredContentSize = CGSizeMake([UIScreen mainScreen].bounds.size.width, [UIScreen mainScreen].bounds.size.height - 44);
...
- (instancetype)initWithMaxImagesCount:(NSInteger)maxImagesCount columnNumber:(NSInteger)columnNumber delegate:(id<TZImagePickerControllerDelegate>)delegate pushPhotoPickerVc:(BOOL)pushPhotoPickerVc isLongVideo:(BOOL)isLongVideo{
...
- (instancetype)initWithMaxImagesCount:(NSInteger)maxImagesCount columnNumber:(NSInteger)columnNumber delegate:(id<TZImagePickerControllerDelegate>)delegate pushPhotoPickerVc:(BOOL)pushPhotoPickerVc enabledOriginSize:(BOOL)enabledOriginsize isLongVideo:(BOOL)isLongVideo{
    _pushPhotoPickerVc = pushPhotoPickerVc;
    TZAlbumPickerController *albumPickerVc = [[TZAlbumPickerController alloc] init];
    albumPickerVc.columnNumber = columnNumber;
    self = [super initWithRootViewController:albumPickerVc];
    if (self) {
        ...
        self.autoDismiss = YES;
        self.columnNumber = columnNumber;
        self.enableOriginSize = enabledOriginsize;
        self.isLongVideo = isLongVideo;
        [self configDefaultSetting];
...
- (void)pushPhotoPickerVc {
    ...
    if (!_didPushPhotoPickerVc && _pushPhotoPickerVc) {
        ...
        photoPickerVc.enabledOriginSize = self.enableOriginSize;
        photoPickerVc.longVideo = self.isLongVideo;
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    photoPickerVc.columnNumber = self.columnNumber;
    TZImagePickerController *imagePickerVc = (TZImagePickerController *)self.navigationController;
    photoPickerVc.enabledOriginSize = imagePickerVc.enableOriginSize;
    photoPickerVc.longVideo = imagePickerVc.isLongVideo;
